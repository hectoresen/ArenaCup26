...
| [`docs/security.md`](docs/security.md)                 | Runbook de seguridad: secrets que gestionamos, auditoría de cyber issues (CRIT/WEAK), checklist pre-launch, operativa manual del owner (rotar credenciales, activar Sentry/Plausible/backups/push, configurar canal de contacto público). |
