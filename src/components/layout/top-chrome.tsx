 ...
 *
 * **Nota responsiva**: el contenido principal de la página debe
 * reservar `pt-16 sm:pt-20` (o equivalente) para no quedar pisado por
 * estos slots — son `position: fixed` y no participan del flujo.
 */
