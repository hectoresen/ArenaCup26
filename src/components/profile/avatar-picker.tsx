  ...
  return (
    <>
      <button
        ...
        aria-label={
          cooldownActive ? t("cooldownAria", { minutes: cooldownMinutes }) : t("changeAvatarAria")
        }
      >
        {trigger}
      </button>
        ...
        createPortal(
          ...
          >
            ...
            <div className="flex h-[100dvh] w-full flex-col bg-card sm:h-auto sm:max-h-[90vh] sm:max-w-md sm:rounded-3xl sm:border-2 sm:border-gold/30 sm:shadow-[0_24px_48px_rgba(0,0,0,0.5)]">
              ...
              <footer className="flex shrink-0 justify-end gap-2 border-t border-border px-5 pb-[max(1rem,env(safe-area-inset-bottom))] pt-4 sm:pb-4">
                <button
                  type="button"
                  onClick={discard}
                  disabled={isPending}
