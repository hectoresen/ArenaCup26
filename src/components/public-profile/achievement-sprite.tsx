    ...
    >
      <defs>
        ...
        <symbol id="ach-invite" viewBox="0 0 36 36">
          ...
          <path
            d="M3 30 C3 22 7 18 12 18 C16 18 19 21 20 25"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.7"
            strokeLinecap="round"
        ...
        <symbol id="ach-flame" viewBox="0 0 36 36">
          <path
            d="M18 4 C18 4 27 13 27 21 C27 27.6 23 32 18 32 C13 32 9 27.6 9 21 C9 15 13 10 13 10 C13 10 12 17 17 19 C17 19 14.5 13.5 18 4Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.9"
            strokeLinejoin="round"
          />
          <path
            d="M18 18 C18 18 22 22 22 26 C22 29 20.2 31 18 31 C15.8 31 14 29 14 26 C14 22 18 18 18 18Z"
            fill="currentColor"
            opacity="0.2"
          />
        </symbol>
        ...
        <symbol id="ach-top100" viewBox="0 0 36 36">
          <polygon
            points="18,3 21,12 31,12 23,18 26,28 18,22 10,28 13,18 5,12 15,12"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.7"
            strokeLinejoin="round"
        ...
        <symbol id="ach-bolt" viewBox="0 0 36 36">
          <polygon
            points="22,3 11,21 18,21 14,33 25,15 18,15"
            fill="none"
            stroke="currentColor"
            strokeWidth="2.2"
            strokeLinejoin="round"
        ...
        <symbol id="ach-double-flame" viewBox="0 0 36 36">
          <path
            d="M13 7 C13 7 19 13 19 19 C19 23.6 16.5 27 13 27 C9.5 27 7 23.6 7 19 C7 15 10 11 10 11 C10 11 9.2 16 12.5 18 C12.5 18 10.5 13 13 7Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.7"
            strokeLinejoin="round"
          />
          <path
            d="M23 4 C23 4 30 11 30 19 C30 24.8 27 29 23 29 C19 29 16 24.8 16 19 C16 14 19.5 10 19.5 10 C19.5 10 18.5 16 22 18 C22 18 19.5 12 23 4Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.9"
            strokeLinejoin="round"
          />
          <path
            d="M23 18 C23 18 26 21 26 24.5 C26 27 24.7 29 23 29 C21.3 29 20 27 20 24.5 C20 21 23 18 23 18Z"
            fill="currentColor"
            opacity="0.18"
          />
        </symbol>
        ...
        <symbol id="ach-eye" viewBox="0 0 36 36">
          <path
            d="M2 18 C7 9 12 5 18 5 C24 5 29 9 34 18 C29 27 24 31 18 31 C12 31 7 27 2 18Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
          />
        ...
        <symbol id="ach-trophy" viewBox="0 0 36 36">
          ...
          <path
            d="M7 7 C5 7 3 9 3 14 C3 20 7 24 13 26 L18 27 L23 26 C29 24 33 20 33 14 C33 9 31 7 29 7 Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinejoin="round"
          />
          <path
            d="M7 12 C2 11 1 17 3 20 C4 22 6 23 8 22"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          />
          <path
            d="M29 12 C34 11 35 17 33 20 C32 22 30 23 28 22"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          ...
          <line
            ...
            x2="12"
            y2="19"
            stroke="rgba(255,248,200,0.35)"
            strokeWidth="2.5"
            strokeLinecap="round"
          />
          <polygon
            points="18,2 19.4,6 23.5,6 20.2,8.4 21.5,12.5 18,10 14.5,12.5 15.8,8.4 12.5,6 16.6,6"
            fill="currentColor"
            opacity="0.9"
          />
        </symbol>
        ...
        <symbol id="ach-top10" viewBox="0 0 36 36">
          <polygon
            points="18,2 21.5,12 33,12 23.5,18.5 27,29 18,22.5 9,29 12.5,18.5 3,12 14.5,12"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
        ...
        <symbol id="ach-podium3" viewBox="0 0 36 36">
          ...
          <polygon
            points="18,2 19.5,7 24.5,7 20.5,10 22,15 18,12 14,15 15.5,10 11.5,7 16.5,7"
            fill="currentColor"
            opacity="0.85"
          />
        </symbol>
        ...
        <symbol id="ach-podium2" viewBox="0 0 36 36">
          ...
          <polygon
            points="10.5,3 12.5,9 19,9 14,12.5 16,18.5 10.5,15 5,18.5 7,12.5 2,9 8.5,9"
            fill="currentColor"
            opacity="0.9"
          />
        </symbol>
        ...
        <symbol id="ach-crown" viewBox="0 0 36 36">
          <path
            d="M4 28 L7 14 L13 22 L18 8 L23 22 L29 14 L32 28 Z"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            strokeLinejoin="round"
        ...
        <symbol id="ach-goat" viewBox="0 0 36 36">
          <path
            d="M10 10 C7 6 4 4 3 7 C2 10 5 12 8 13"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          />
          <path
            d="M26 10 C29 6 32 4 33 7 C34 10 31 12 28 13"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinecap="round"
          ...
          />
          <path
            d="M16 28 C16 31 18 33 18 33 C18 33 20 31 20 28"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
